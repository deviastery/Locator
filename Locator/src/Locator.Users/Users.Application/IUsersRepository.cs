...
public interface IUsersRepository
{
    ...
    /// <param name="userId">ID of user</param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Refresh refresh token</returns>
    Task<Result<RefreshToken, Error>> GetRefreshTokenByUserIdAsync(Guid userId, CancellationToken cancellationToken);

    /// <summary>
    /// Gets token of a job search service
    /// </summary>
    /// <param name="tokenId">ID of token of a job search service</param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Token of a job search service</returns>
    Task<Result<EmployeeToken, Error>> GetEmployeeTokenByIdAsync(Guid tokenId, CancellationToken cancellationToken);
    ...
    /// <summary>
    /// Deletes all refresh token by user ID
    /// </summary>
    /// <param name="userId">ID of user</param>
    /// <param name="cancellationToken">Cancellation token</param>
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Token of a job search service</returns>
    Task<Result<EmployeeToken, Error>> GetEmployeeTokenByUserIdAsync(Guid userId, CancellationToken cancellationToken);
}